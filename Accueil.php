...
<html lang="en">
    ...
    <body class="bg-info">
        <div id="wlcm" class="container MW4 bg-white">
            <div class="row pl-4 pb-4">
                <h4 class="text-center display-4">welcome <?= $nom.' '.$prenom ?></h4>
            </div>
            <div class="row justify-content-center">
                <button class="btn btn-primary">nouvelle reclamation</button>
            </div>
            <div class="row justify-content-center py-4">
                <button class="btn btn-primary" style="width:173px;">vérifier les anciennes réclamations</button>
            </div>
        </div>
        <div class="sidenav">
            <ul class="list-unstyled components">
                ...
                <li><a href="forgetten_password.php"><button class="btn">changer le mot de passe</button></a></li>
            </ul>
        </div>
