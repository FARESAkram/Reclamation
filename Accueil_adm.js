...
link = "http://localhost/MYPROJECTS/Reclamation/Accueil_adm.php"
link = "http://localhost/MYPROJECTS/Reclamation/Accueil_adm.php"
...
const f = () =>
{
    ...
    {
        let link = 'http://localhost/MYPROJECTS/Reclamation/reclamation_sans_reponse.php' ;
        window.location.href = link ;
    }
    else
    {
        let link = 'http://localhost/MYPROJECTS/Reclamation/Accueil_adm.php' ;
        window.location.href = link ;
    }
...
const clickablerow = (ids) =>
{
    ...
    {
        let link = 'http://localhost/MYPROJECTS/Reclamation/reply.php?ids=' ;
        link += ids;
        window.location.href = link ;
    }
    else
